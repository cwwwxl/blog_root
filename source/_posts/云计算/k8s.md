---
title: k8s搭建2
cover: 'https://s2.loli.net/2023/01/26/4WyLJQKtiMNoxl5.png'
tags: k8s
categories: 云计算
top_img: 'https://s2.loli.net/2023/01/26/4WyLJQKtiMNoxl5.png'
abbrlink: 764d0a48
---
#### 2.6 环境初始化
...
[root@master ~]# kubeadm init \
	--apiserver-advertise-address=192.168.169.100 \
...
![img](https://s2.loli.net/2023/01/20/NX47UjpanZ5AruM.png)
...
![img](https://s2.loli.net/2023/01/20/pdK6OJnImvZGNR1.png)

浏览器测试结果：

![img](https://s2.loli.net/2023/01/20/lZzMhoHsP1qUjNY.png)
