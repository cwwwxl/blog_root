---
title: 8.数据存储
cover: 'https://s2.loli.net/2023/01/22/eXlHB4MPaELnAKS.jpg'
tags: k8s
categories: 云计算
top_img: 'https://s2.loli.net/2023/01/26/JH3K2AMPlb9W6rU.jpg'
abbrlink: df6f0f7b
sticky:
---
# 8. 数据存储
...
![img](https://s2.loli.net/2023/01/24/tYjE9eGU8FKqQM3.png)
...
![img](D:\学习笔记\k8s\Kubenetes.assets\image-20200413214031331.png)
...
![img](https://s2.loli.net/2023/01/24/7CE6sDdgyHXn2uJ.png)
...
![img](https://s2.loli.net/2023/01/24/19QWj2qopyCStJl.png)
...
![img](https://s2.loli.net/2023/01/24/OoIxBl6kVsCiHFX.png)
...
![img](https://s2.loli.net/2023/01/24/XDtu6VIOBh73FS2.png)
...
![img](https://s2.loli.net/2023/01/24/PmTWQnHcDp1C4G3.png)
...
![img](https://s2.loli.net/2023/01/24/Z4WbLKugV1Y5UNn.png)
...
![img](https://s2.loli.net/2023/01/24/y1a9d4hNgbkqnzB.png)
...
![image-20200520144548997](https://s2.loli.net/2023/01/24/TLobRErwyncdlms.png)

出现下面的页面代表成功

![image-20200520144959353](https://s2.loli.net/2023/01/24/TQUDXvcFi3Pp8fL.png)
...
![img](https://s2.loli.net/2023/01/24/wfJEueILK6bQONq.png)

**扩缩容**

在`Deployment`上点击`规模`，然后指定`目标副本数量`，点击确定

![img](https://s2.loli.net/2023/01/24/rsqvAmzoPJdVGBY.png)

**编辑**

在`Deployment`上点击`编辑`，然后修改`yaml文件`，点击确定

![image-20200520163253644](https://s2.loli.net/2023/01/24/GvfDZWPiJtjMadx.png)

**查看Pod**

点击`Pods`, 查看pods列表

![img](https://s2.loli.net/2023/01/24/SQ1v5Vfqxn8GTka.png)

**操作Pod**

选中某个Pod，可以对其执行日志（logs）、进入执行（exec）、编辑、删除操作

![img](https://s2.loli.net/2023/01/24/gOzA1Cacy2xTBKr.png)
