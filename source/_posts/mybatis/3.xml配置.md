---
title: 3.xml配置
cover: 'https://s2.loli.net/2023/03/24/fBK74zFSbJRuH91.jpg'
tags: mybatis
categories: mybatis
top_img: 'https://s2.loli.net/2023/03/24/fBK74zFSbJRuH91.jpg'
abbrlink: 5cceded5
---
## 三.XML配置
...
这些属性可以在外部进行配置，并可以进行动态替换。你既可以在典型的 Java 属性文件中配置这些属性，也可以在 properties 元素的子元素中设置。声明一个db.properties文件
...
![image-20230410092031128](https://s2.loli.net/2023/04/10/3LwXMfJFvKHeglW.png)
