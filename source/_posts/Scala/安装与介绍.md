---
title: 1.Scala介绍与配置
cover: 'https://pic.cwwwxl.top/img/t01e5f605262fb61fb4.jpg'
tags: Scala
categories: Scala
top_img: 'https://pic.cwwwxl.top/img/t01e5f605262fb61fb4.jpg'
abbrlink: c5ff6750
---
...
![img](https://s2.loli.net/2023/02/23/KCNqtBLnhrgFiwU.png)

### 2.3 创建Scala项目

在 IDEA 中依次点击 **File** => **New** => **Project** 选项卡，然后选择创建 `Scala—IDEA` 工程：

![img](https://s2.loli.net/2023/02/23/tb7qHLBwPYya6ej.png)
...
![img](https://s2.loli.net/2023/02/23/gsE9rHZbKIoe6lO.png)
...
[![img](https://s2.loli.net/2023/02/23/u61g8WtodCbQkai.png)

由于安装时已经自动配置好环境变量，所以 IDEA 会自动选择对应版本的 SDK。

![img](https://s2.loli.net/2023/02/23/7qC1GkSIbwyXtVN.png)
### 2.5 创建Hello World

在工程 `src` 目录上右击 **New** => **Scala class** 创建 `Hello.scala`。输入代码如下，完成后点击运行按钮，成功运行则代表搭建成功。

![img](https://s2.loli.net/2023/04/12/GnEfF2dlUwoPSr8.png)

### 2.6 切换Scala版本

在日常的开发中，由于对应软件（如 Spark）的版本切换，可能导致需要切换 Scala 的版本，则可以在 `Project Structures` 中的 `Global Libraries` 选项卡中进行切换。

[![img](https://s2.loli.net/2023/02/23/DPiSkH2wprAsFTu.png)

### 2.7 使用scala命令行

采用 `msi` 方式安装，程序会自动配置好环境变量。此时可以直接使用命令行工具：

[![img](https://s2.loli.net/2023/02/23/3qQnYVplPRDzIJj.png)
