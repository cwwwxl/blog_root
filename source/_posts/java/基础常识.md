---
title: 1.基础常识
cover: 'https://s2.loli.net/2023/03/24/OlfXdRy4sGMIqup.png'
tags: 面试题
categories: Java面试题
abbrlink: 291cb8a2
top_img: 'https://s2.loli.net/2023/03/24/OlfXdRy4sGMIqup.png'
---
## 基础概念与常识（面试题）
...
![img](https://s2.loli.net/2023/04/02/BFshdrLJtUEH9vw.jpg)
...
![Java程序转变为机器代码的过程](https://s2.loli.net/2023/04/02/htFSsiQP9uzvfAm.png)
...
![编译型语言和解释型语言](https://s2.loli.net/2023/04/02/8zpsYXiflG9tQxA.png)
...
![oracle jdk release cadence](https://s2.loli.net/2023/04/02/8ycHq7Lhu6jBMJk.jpg)
...
![img](https://s2.loli.net/2023/04/02/gRkQGOLj9EUHqJs.png)
...
![img](https://s2.loli.net/2023/04/02/7UK2EHo1vtcyiPX.png)
...
![img](https://s2.loli.net/2023/04/02/NeQRVfSXW65xICt.png)
...
关于 `BigDecimal` 的详细介绍，可以看看我写的这篇文章：[BigDecimal 详解](https://github.com/Snailclimb/JavaGuide/blob/main/docs/java/basis/bigdecimal.md)。
...
- 来源 https://github.com/Snailclimb/JavaGuide/blob/main/docs/java/basis/java-basic-questions-01.md#jvm-vs-jdk-vs-jre
