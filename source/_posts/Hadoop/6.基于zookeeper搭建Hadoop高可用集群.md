---
title: 6.基于Zookeeper环境搭建Hadoop高可用集群
cover: 'https://s2.loli.net/2023/03/24/s76XzBtDvFJioSh.png'
tags: Zookeeper
categories: Hadoop
top_img: 'https://s2.loli.net/2023/03/24/s76XzBtDvFJioSh.png'
abbrlink: b4e8f16
---
...
![img](https://s2.loli.net/2023/03/25/OdKJHyBRiVPWmhs.png)
...
![img](https://s2.loli.net/2023/03/25/NrjMiIC6RbSqp2Z.png)

### 1.3 NameNode 主备切换

NameNode 实现主备切换的流程下图所示：

![img](https://s2.loli.net/2023/03/25/4kJG73UPuAZgisM.png)
...
![img](https://s2.loli.net/2023/03/25/QLgVYCr4GanvzcB.png)

## 三、前置条件

- 所有服务器都安装有 JDK，安装步骤可以参见：[Linux 下 JDK 的安装](https://www.cwwwxl.top/posts/51741172.html)；
- 搭建好 ZooKeeper 集群，搭建步骤可以参见：[Zookeeper 单机环境和集群环境搭建](https://www.cwwwxl.top/posts/3bb5ed61.html)
...
![img](https://s2.loli.net/2023/03/25/81IZFx7PioeHctn.png)

而 hadoop002 上的 `NameNode` 则处于备用状态：

![img](https://s2.loli.net/2023/03/25/Lg5eahyAn2z9Wsb.png)
...
![img](https://s2.loli.net/2023/03/25/WpcmQEDG8gyt9wC.png)
...
![img](https://s2.loli.net/2023/03/25/n9dP4tFgQYeciMv.png)
...
![img](https://s2.loli.net/2023/03/25/xVvk68wnzY9lHfB.png)
