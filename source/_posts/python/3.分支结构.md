---
title: 3.分支结构
cover: 'https://pic.cwwwxl.top/img/QQ%E5%9B%BE%E7%89%8720230126142504.jpg'
tags: python
categories: python
top_img: 'https://pic.cwwwxl.top/img/QQ%E5%9B%BE%E7%89%8720230126142504.jpg'
abbrlink: 814577ae
---
## 分支结构
...
[![$$f(x)=\begin{cases} 3x-5&\text{(x>1)}\x+2&\text{(-1}\leq\text{x}\leq\text{1)}\5x+3&\text {(x<-1)}\end{cases}$$](D:\学习笔记\图片\formula_1.png)](https://github.com/jackfrued/Python-100-Days/blob/master/Day01-15/res/formula_1.png)
